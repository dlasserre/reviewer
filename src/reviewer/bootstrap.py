...
def _yaml_profil(*, projet: str, org: str, workspace: Path, lecture: str,
    ...
    lignes += [
        ...
        "max_review_cycles: 3",
        "",
        "# Le nombre d'allers-retours d'UN job. Ecrit ici plutot qu'herite en",
        "# silence : a 60, deux jobs reels ont ete coupes alors que leur",
        "# correctif etait ecrit ET teste (backend#727 le 27/08, #743 le 30/08).",
        "# C'est un plafond, pas une cible — un job qui aboutit en 40 tours",
        "# coute 40 tours. Le temps et l'argent sont bornes ailleurs, dans",
        "# runner.yaml (`max_minutes_per_job`, `max_jobs_per_day`).",
        "max_turns: 120",
        "",
        "reviewers:",
